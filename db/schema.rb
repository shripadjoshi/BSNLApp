...
ActiveRecord::Schema.define(version: 20181029042220) do
  ...
  create_table "sim_targets", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "year"
    t.text "target", limit: 16777215
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
